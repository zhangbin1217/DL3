...
def get_args(argv):
    ...
    parser.add_argument('--model_type', type=str, default='vgg', help="lenet(default)|vgg|resnet")
    parser.add_argument('--model_name', type=str, default='VGG8', help="LeNet(default)|LeNetC|VGGS|VGG8|VGG16|ResNet18|ResNet101 ...")
    parser.add_argument('--dataset_type', type=str, default='default')
    parser.add_argument('--dataset', type=str, default='CIFAR10', help="MNIST(default)|CIFAR10|CIFAR100|Omniglot|Omniglot_eval_Old_Church_Slavonic ...")
    ...
    parser.add_argument('--loss', type=str, default='CE', choices=['CE', 'KCL', 'MCL', 'DPS'],
