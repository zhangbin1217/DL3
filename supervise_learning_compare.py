...
def get_args(argv, model_type, model_name, lo):
    ...
    parser.add_argument('--schedule', nargs="+", type=int, default=[80, 120],
...
if __name__ == '__main__':
    # a, loss_ce = run(get_args(sys.argv[1:],"lenet","LeNet","CE"))
    # a, loss_kcl = run(get_args(sys.argv[1:],"lenet","LeNet", "KCL"))
    # a, loss_mcl = run(get_args(sys.argv[1:],"lenet","LeNet", "MCL"))
